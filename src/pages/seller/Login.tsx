  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user?.user_metadata?.role !== 'seller') {
        ...
        throw new Error('Access Denied: You do not have seller credentials.');
      }

      showToast('success', 'Logged In', 'Welcome to the Swaxtika Seller Portal');
      navigate('/');
    } catch (err: any) {
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-500 to-secondary-light relative p-12 flex-col justify-between overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/30 mb-8 animate-fade-in">
              ...
              <span className="text-xs font-bold font-display uppercase tracking-wider text-white">Partner & Seller Portal</span>
            </div>
            <h1 className="text-4xl lg:text-5xl font-display font-extrabold text-white leading-tight">
              Grow your <span className="text-accent">business</span> with us.
            </h1>
            <p className="mt-4 text-white/90 text-sm max-w-sm font-sans leading-relaxed">
              Log in to access your business overview, product inventory, customer reviews, and order fulfillment controls.
            </p>
          </div>
          ...
          <div className="relative z-10 flex items-center justify-between border-t border-white/20 pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-white/60 text-xs mt-1">Sellers & Merchants</div>
              </div>
            </div>
          ...
          <div className="max-w-md mx-auto w-full">
            <div className="mb-10 text-center lg:text-left">
              ...
              <p className="text-gray-500 text-sm mt-2">
                Log in to the dashboard with your merchant credentials.
              </p>
            </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="partner@swaxtika.com"
                  />
                </div>
              </div>
